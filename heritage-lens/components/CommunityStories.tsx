...
export default function CommunityStories() {
  return (
    <section className="relative overflow-hidden bg-background px-6 py-24 text-foreground sm:px-10 lg:px-16">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          <div>
            ...
            <h2 className="text-4xl font-semibold text-foreground [text-shadow:0_0_30px_rgba(212,175,55,0.14)] sm:text-5xl">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {stories.map((story, index) => (
            ...
            >
              <div className="relative h-full overflow-hidden rounded-xl border border-white/10 bg-white/[0.045] p-6 backdrop-blur-xl">
                <div className="absolute right-6 top-5 text-7xl font-semibold leading-none text-gold/15 transition duration-500 group-hover:text-gold/25">
                  "
                </div>
                <p className="relative text-lg leading-8 text-foreground/88">
                  "{story.quote}"
                </p>
                <div className="mt-6 border-t border-white/10 pt-5">
                  <h3 className="text-2xl font-semibold text-foreground transition duration-300 group-hover:text-gold">
                    {story.title}
                  </h3>
