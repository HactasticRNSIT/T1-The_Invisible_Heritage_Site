...
export default function SiteCard({
  ...
  return (
    <article className="group rounded-xl bg-[linear-gradient(135deg,rgba(212,175,55,0.65),rgba(255,255,255,0.14),rgba(47,111,115,0.45))] p-px shadow-[0_24px_60px_rgba(0,0,0,0.34)] transition duration-500 hover:-translate-y-2 hover:shadow-[0_30px_80px_rgba(212,175,55,0.16)]">
